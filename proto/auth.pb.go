...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\amessage\x18\x04 \x01(\tR\amessage2\x89\x01\n" +
	"\vAuthService\x120\n" +
	"\x05Login\x12\x12.auth.LoginRequest\x1a\x13.auth.LoginResponse\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB&Z$github.com/renatomsa/auth-grpc/protob\x06proto3"
