...
const file_proto_auth_proto_rawDesc = "" +
	...
	"\x05token\x18\x01 \x01(\tR\x05token2\xc9\x01\n" +
	"\vAuthService\x120\n" +
	...
	"\fRefreshToken\x12\x19.auth.RefreshTokenRequest\x1a\x13.auth.LoginResponseB&Z$github.com/renatomsa/auth-grpc/protob\x06proto3"
...
var file_proto_auth_proto_depIdxs = []int32{
	...
	1, // 5: auth.AuthService.RefreshToken:output_type -> auth.LoginResponse
